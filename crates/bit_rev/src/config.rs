...
impl Config {
    ...
    pub fn session_options(&self) -> SessionOptions {
        ...
        SessionOptions {
            ...
            alt_download_limit: self.alt_download_limit,
            alt_upload_limit: self.alt_upload_limit,
            alt_schedule: self.alt_schedule.clone(),
            seed_ratio_limit: self.seed.ratio_limit,
            seed_time_limit: self.seed.time_limit,
            max_active_downloads: self.queue.max_active_downloads,
            max_active_uploads: self.queue.max_active_uploads,
